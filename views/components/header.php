<header aria-label="main navigation">
    <nav id="main-nav" aria-label="main navigation">
        <div class="flex-c-c">
            <a id="header-logo" href="index.php?route=/" aria-label="Acceuil - Tom Troc">
            ...
            <ul class="nav-list__left">
                <li>
                    <a aria-label="Acceuil" class="<?= UTILS::checkActiveRoute("/") . UTILS::checkActiveRoute("")  ?>" href="index.php?route=/">Accueil</a>
                </li>
                <li>
        ...
        <ul class="nav-list__right">
            <?php if(isset($_SESSION['auth_token'])): ?>
                <li class="message-list-item">
                    <span class="message-logo" aria-hidden="true"></span>
                ...
                <li>
                    <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="path-1-inside-1_19966_31" fill="white">
        ...
        <div class="header-mobile-navigation ">
            <button aria-label="Fermer le menu" class="close-menu-btn">
